...
This is an APPROXIMATION, not an authoritative CEFR classification. The rank
passed in is the word's position among *study words* -- i.e. after function
words and bare grammatical inflections are filtered out (see
...
vocabulary, not raw corpus tokens. Cumulative:
    ...
    rank <= 3000  -> B1
    rank <= 4000  -> B2
    rank >  4000  -> out of scope (A1-B2 only)
